...
public class RemoteFrame extends JFrame implements Runnable {
    ...
    public RemoteFrame(ClientPanel clientPanel, CommonBus commonBus, String quality) throws Exception {
        ...
        this.setIconImage(new ImageIcon(this.getClass().getClassLoader().getResource("IMAGES/window_icon.png")).getImage());
    ...
    private void setupWindow() throws Exception {
        ...
        screenSize.height -= (taskbarInsets.top + taskbarInsets.bottom + frameInsets.top + menuBar.getPreferredSize().height);
