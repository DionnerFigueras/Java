...
public class MainFrame extends JFrame {
    ...
    private void initUI() {
        ...
        //setSize(WIDTH_FRAME, screenSize.height - HEIGHT_TASKBAR);
    ...
    private void initComponents() {
        ...
        //Modificacion
        //JPanel taskbarContainer = new JPanel(new BorderLayout());
        //taskbarContainer.add(taskbarPanel, BorderLayout.NORTH);
        ...
        //Modificado
        //add(taskbarContainer, BorderLayout.NORTH);
        //contentPane = new JPanel(new GridBagLayout()); // GridBagLayout para el contenido principal
...
/*         contentPane.add(clientPanel, "client");
        contentPane.add(serverPanel, "server");
        contentPane.add(mainChatPanel, "chat"); */
    ...
    private void showPanelsSlider(JPanel show_panel, JPanel hide_panel, boolean isLeft) {
        ...
        // Actualizar el CardLayout para mostrar el panel correspondiente
        
        //Original
        //CardLayout cardLayout = (CardLayout) getContentPane().getLayout();
        //cardLayout.show(getContentPane(), show_panel.getName());

        //Modificado
        //JPanel contentPane = (JPanel) getContentPane().getComponent(0);
        //CardLayout cardLayout = (CardLayout) contentPane.getLayout();
        //cardLayout.show(contentPane, show_panel.getName());
